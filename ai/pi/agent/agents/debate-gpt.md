---
name: debate-gpt
description: "Debate agent (GPT side). Used exclusively by the debate skill for multi-model consensus loops. Not intended for direct invocation."
model: devai/gpt-5.3-codex
color: green
---
